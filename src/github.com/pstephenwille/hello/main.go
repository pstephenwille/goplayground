...
can include line breaks.` // Same string type.
	...
	var myarr = make([]int, 50, 100)
	l := len(myarr);


	fmt.Println(`my array, len, cap `, myarr, l, cap(myarr))
...
func learnConcurrency() {
	...
	select {
	case i := <-c:
	// The value received can be assigned to a variable,
		fmt.Printf("it's a %T", i)
	case <-cs:
	// or the value received can be discarded.
...
Originally contributed by Sonia Keys, and updated by 23 contributor(s).
Creative Commons License

© 2015 Sonia Keys, Christopher Bess, Jesse Johnson, Quint Guvernator, Jose Donizetti, Alexej Friesen
